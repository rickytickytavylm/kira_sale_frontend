...
(function () {
  ...
  // Хвост guide/web/webinar — как в Telegram: сразу в чат, ссылка на флагманский курс.
  ...
  const WEBINAR_INTRO =
    ...
    "Дальше по теме созависимости можно присоединиться к курсу «Любить, не теряя себя»: " +
    "1 месяц, 4 недели, 4 вебинара, 4 терапевтические группы, " +
    "2 консультации с психологом, домашние задания и чат поддержки. " +
